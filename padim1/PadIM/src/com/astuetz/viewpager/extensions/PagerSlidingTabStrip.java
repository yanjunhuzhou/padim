...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        underlineHeight = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_underlineHeight,
                underlineHeight);
        dividerPadding = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_dividerPadding,
                dividerPadding);
        tabPadding = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_tabPaddingLeftRight,
                tabPadding);
        tabBackgroundResId = a.getResourceId(R.styleable.PagerSlidingTabStrip_tabBackground,
                tabBackgroundResId);
    ...
    private void updateTabState(int position) {
        /*
         * try { for (int i = 0; i < tabsContainer.getChildCount(); i++) { if (i != position) {
         * tabsContainer.getChildAt(i).setSelected(false); } else { tabsContainer.getChildAt(i).setSelected(true); } } }
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof TextView) {
                ...
                if (getColorStateList() != null) {
                    tab.setTextColor(getColorStateList());
                } else {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!checkedTabWidths && childWidth > 0 && myWidth > 0) {
            ...
            if (childWidth <= myWidth) {
                for (int i = 0; i < tabCount; i++) {
                    // 注释掉了，在添加tab的时候直接weight=1设置进去了。这里不用设置了
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (tab instanceof TextView) {
                TextView v = (TextView) tab;
                if (i == pager.getCurrentItem()) {
                    v.setTextColor(selectedColor);
                } else {
    ...
    /** 选中tab之后文字的颜色 */
    private int selectedColor = 0xFF666666;

    public void setIndicatorColor(int indicatorColor) {
        this.indicatorColor = indicatorColor;
        this.selectedColor = indicatorColor;
        invalidate();
    }
