...
import com.example.padim.adapters.MyFileAdapter;
...
public class MyFileManager extends ListActivity {
	 ...
	 * 
	 * // 判断文件MimeType的method private String getMIMEType(File f) { String
	 * type=""; String fName=f.getName(); // 取得扩展名 String
	 * end=fName.substring(fName.lastIndexOf(".")
