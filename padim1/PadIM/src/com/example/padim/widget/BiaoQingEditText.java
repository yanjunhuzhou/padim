 ...
 *2011-8-25
 */
public class BiaoQingEditText extends EditText {
	 ...
	 * @param context
	 */
	public BiaoQingEditText(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}
	
	public BiaoQingEditText(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void setBiaoQingText(CharSequence text){
        ...
        getText().insert(cursor, txtToImg(new SpannableString(text.toString()), 0));
	}
