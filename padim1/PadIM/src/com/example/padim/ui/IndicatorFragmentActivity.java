...
import com.example.padim.GroupCheckActivity;
import com.example.padim.MainActivity;
import com.example.padim.R;
import com.example.padim.SplashActivity;
...
public abstract class IndicatorFragmentActivity extends FragmentActivity implements OnPageChangeListener {
    ...
    private LinearLayout mGroupBtnLayout;
    ...
    private final void initViews() {
        ...
        mBackBtnLayout = (LinearLayout)findViewById(R.id.back_btn_layout);
        mGroupBtnLayout = (LinearLayout)findViewById(R.id.group_btn_layout);
        mBackBtnLayout.setOnTouchListener(new OnTouchListener(){

			@Override
			public boolean onTouch(View arg0, MotionEvent arg1) {
				// TODO Auto-generated method stub
				if(arg1.getAction() == MotionEvent.ACTION_DOWN)
					mBackBtnLayout.setSelected(true);
				if(arg1.getAction() == MotionEvent.ACTION_UP)
					mBackBtnLayout.setSelected(false);
				return false;
			}});
        
        mGroupBtnLayout.setOnTouchListener(new OnTouchListener(){

			@Override
			public boolean onTouch(View arg0, MotionEvent arg1) {
				// TODO Auto-generated method stub
				if(arg1.getAction() == MotionEvent.ACTION_DOWN){
					mGroupBtnLayout.setSelected(true);
					Intent intent = new Intent(IndicatorFragmentActivity.this,
							GroupCheckActivity.class);
					startActivity(intent);
				}
				if(arg1.getAction() == MotionEvent.ACTION_UP)
					mGroupBtnLayout.setSelected(false);
